...
const About = () => {
  return (
    <section id="about-loc"  className="min-h-[50vh] w-screen p-5 md:p-24 bg-[#3b3c3f]">
      <h1 className="text-4xl md:text-5xl font-bold text-[#fbfbfb]">About</h1>
      <div className="flex flex-col md:flex-row items-start gap-5 md:gap-0">
        <div className="h-0.5 w-full md:w-[330px] bg-[#fec86a] md:mr-8" />
        <p className="text-[#fbfbfb] md:text-xl font-serif">
          ...
          <span className="text-[#fec86a]"> strong foundation in science and mathematics.</span>
          <br />
          <br />
          My passion for coding started early, and
          <span className="text-[#fec86a]"> I've since honed my skills in Node.js, Express, React, next,js.</span>
